...
class AdvancedRAGSystem:
    ...
    def __init__(self):
        ...
        # Pinecone configuration from validated config
...
# Note: Global functions removed in favor of dependency injection
# Use services.dependency_container.get_rag_system() instead
